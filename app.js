...
function addElement(type) {
  ...
  const content = {
    ...
    image: '<div><p class="eyebrow">FEATURED STORY</p><h2 contenteditable="true">A place for your image.</h2><p contenteditable="true">Replace this card with an image after exporting.</p></div>',
    divider: '<hr />',
  };
